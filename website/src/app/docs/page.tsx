    ...
    <main className="docs-page site-shell">
      ...
      <div className="docs-layout">
        ...
        <div className="docs-content">
          ...
          <section id="agents"><span className="doc-number">03</span><h2>Agent adapters</h2><p>Source builds include hooks for Claude Code, Cursor, Gemini CLI, and GitHub Copilot CLI. The current published release predates them. Each adapter passes local hook and changed-line tests; live sessions with those four hosts still need checking.</p><p>Build both commands from source, then choose an agent. For example:</p><Command command="why-diff init --agent cursor --global" /><p>Use <code>claude</code>, <code>gemini</code>, or <code>copilot</code> in place of <code>cursor</code>. The <a href="https://github.com/prsuyal/why-diff/blob/main/docs/agent-adapters.md" target="_blank" rel="noreferrer">adapter setup guide ↗</a> has build commands and host-specific details.</p></section>
