# Agent hook adapters in source builds

Build both binaries from this repository and put them on `PATH` before running the commands below. The currently published release predates these adapters.
